 ...
 * Introdução
   ...
   * Dados e Tarefas
      * Descrição dos dados (especifique a fonte)
      * Procedimentos realizados para processamento/limpeza dos dados, caso existam 
      * Objetivos específicos da análise, em termos de investigações realizadas
   * Visualização 
      * Descrição da visualização produzida (gráficos, dashboards, etc...)
   * Casos de Uso 
      * Descrição da sua investigação  para responder as tarefas (objetivos específicos) do trabalho
   * Conclusões
